    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="AirJaldi, the brand name used by Rural Broadband Pvt. Ltd., a class A Internet Service Provider, provides high-quality broadband connectivity to rural areas ..."
        />
        <meta
          name="description"
          content="AirJaldi, the brand name used by Rural Broadband Pvt. Ltd., a class A Internet Service Provider, provides high-quality broadband connectivity to rural areas ..."
        ...
        <div class="grid">
          <div className="birdOut">
            <div className="birdd">
              <img
                alt="Image Arrow"
                src={`${process.env.url}/qnjyqjew5x5sbmfq0rrp.png`}
              ></img>
            </div>
          </div>
          <Image
            className="myImage"
            src={process.env.url + data.landingAvatar}
            alt="Landing Image"
            layout="fill"
            objectFit="cover"
          />
                ...
                <div class="grid1">
                  ...
                  <div className="data">
                    ...
                    <div className="link">
                      <img
                        alt="Image Arrow"
                        src={`${process.env.url}/kks3py9aencqms2riscm.png`}
                      ></img>
                      <span onClick={() => router.push(`/${number.link}`)}>
                        {number.sectionLink}
                      </span>
                    </div>
                  </div>
      ...
      <Map data={data} />
      <Connection />
      <Project data={data} /> <News />
      <InNews />
      <FieldNews /> {/* <Partner data={data.partners} /> */}
      <Footer />
    </>
  );
}
